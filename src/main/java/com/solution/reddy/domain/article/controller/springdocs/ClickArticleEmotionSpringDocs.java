...
import com.solution.reddy.global.controller.springdocs.UserNotFoundException;
...
@Operation(summary = "기사 이모티콘 누르는 API", description = "기사 이모티콘 누르는 API 입니다.")
@ApiResponses(value = {
...
public @interface ClickArticleEmotionSpringDocs {
}
